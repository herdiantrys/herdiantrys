    ...
    return (
        <div className="min-h-screen pt-24 pb-12 px-4 relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-5xl relative z-10">
                ...
                >
                    <div className="h-48 md:h-64 bg-gradient-to-r from-purple-500/30 to-teal-500/30 relative group">
                        {user.bannerImage?.asset?.url && (
                            <Image
                                src={user.bannerImage.asset.url}
                                alt="Banner"
                                fill
                    ...
                    <div className="px-8 pb-8 relative">
                        <div className="flex flex-col md:flex-row gap-6 items-end -mt-12">
                            <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-[var(--glass-bg)] overflow-hidden bg-gray-800 shadow-xl flex-shrink-0">
                                <Image
                                    src={user.imageURL || user.profileImage?.asset?.url || "/avatar-placeholder.png"}
                                    alt={user.fullName}
                                    fill
                                    className="object-cover"
                                />
                            ...
                            <div className="flex-1 mb-2">
                                <h1 className="text-3xl md:text-4xl font-bold text-[var(--glass-text)] mb-1">{user.fullName}</h1>
                                <p className="text-xl text-[var(--glass-text-muted)] font-medium">@{user.username}</p>
                            </div>
                            {isOwner && (
