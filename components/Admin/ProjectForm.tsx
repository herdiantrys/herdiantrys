...
import { createProject, updateProject, getCategories } from "@/lib/actions/project.actions";
            ...
            <div className="bg-white dark:bg-[#1A1A1A] w-full max-w-5xl max-h-[90vh] rounded-3xl shadow-2xl overflow-y-auto animate-in zoom-in-50 duration-200 scrollbar-hide relative z-10 flex flex-col">
                ...
                <div className="p-8 space-y-8 flex-1">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-6">
                            <div className="group">
                                <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 group-focus-within:text-teal-500 transition-colors">Project Title</label>
                                <input
                                    value={formData.title}
                                    onChange={e => updateFormData({ title: e.target.value })}
                                    className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 focus:border-teal-500 focus:bg-white dark:focus:bg-black/40 outline-none text-gray-900 dark:text-white transition-all duration-300 placeholder-gray-400"
                            ...
                            <div className="group">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-3 rounded-xl bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 focus:border-teal-500 focus:bg-white dark:focus:bg-black/40 outline-none text-gray-900 dark:text-teal-400 font-mono text-sm transition-all duration-300 placeholder-gray-400"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <button
                                    ...
                                    className={`py-3 rounded-xl border flex items-center justify-center gap-2 transition-all duration-300 ${formData.type === "IMAGE" ? "bg-teal-500 text-white border-teal-500 shadow-lg shadow-teal-500/20" : "bg-gray-50 dark:bg-black/20 border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5"}`}
                                >
                                    <ImageIcon size={18} /> <span className="font-medium">Image Based</span>
                                </button>
                                <button
                                    onClick={() => updateFormData({ type: "VIDEO" })}
                                    className={`py-3 rounded-xl border flex items-center justify-center gap-2 transition-all duration-300 ${formData.type === "VIDEO" ? "bg-teal-500 text-white border-teal-500 shadow-lg shadow-teal-500/20" : "bg-gray-50 dark:bg-black/20 border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5"}`}
                                >
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 focus:border-teal-500 focus:bg-white dark:focus:bg-black/40 outline-none text-gray-900 dark:text-white appearance-none transition-all duration-300 cursor-pointer"
                                >
                ...
                <div className="bg-white/80 dark:bg-[#1A1A1A]/80 backdrop-blur-lg border-t border-gray-100 dark:border-white/5 px-8 py-5 flex justify-end gap-3 sticky bottom-0 z-20">
                    ...
                    <button
                        onClick={() => handleSave()}
                        disabled={loading}
                        className={`px-8 py-3 rounded-xl bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-bold shadow-lg shadow-teal-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2 ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
                    >
