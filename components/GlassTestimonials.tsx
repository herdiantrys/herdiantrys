            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <div className="relative max-w-7xl mx-auto">
                        ...
                        >
                            ...
                            >
                                {extendedTestimonials.map((testimonial, index) => (
                                    ...
                                    >
                                        <div className="glass h-full p-8 rounded-3xl border-[var(--glass-border)] relative bg-[var(--glass-bg)] flex flex-col justify-between hover:scale-[1.02] transition-transform duration-500 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] border-white/60 dark:border-white/10">
                        ...
                        {/* Navigation Buttons */}
                        <button
                            className="absolute -left-4 md:-left-12 top-1/2 -translate-y-1/2 p-3 rounded-full glass hover:bg-white/20 transition-all text-[var(--glass-text)] z-10 border-[var(--glass-border)] shadow-sm"
                            onClick={handlePrev}
                        >
                            <ChevronLeft size={24} />
                        </button>
                        <button
                            className="absolute -right-4 md:-right-12 top-1/2 -translate-y-1/2 p-3 rounded-full glass hover:bg-white/20 transition-all text-[var(--glass-text)] z-10 border-[var(--glass-border)] shadow-sm"
                            onClick={handleNext}
                        >
