                        ...
                        <div className="glass p-4 rounded-3xl border-[var(--glass-border)] bg-[var(--glass-bg)] relative group overflow-hidden">
                            <div className="aspect-[3/4] rounded-2xl overflow-hidden relative">
                                ...
                                <div className="absolute bottom-4 left-4 right-4">
                                    ...
                                    <p className="text-teal-400 text-sm">{profile?.headline?.[0]}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-8">
                        ...
                        >
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[var(--glass-text)]">
                                {dict.about.title.design_with} <span className="text-gradient">{dict.about.title.passion}</span> {dict.about.title.purpose}
                            </h2>
